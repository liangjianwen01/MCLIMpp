...
class Args(Tap):
    # environment
    exp_name: str = 'debug'
    exp_dir: str = '/data/junyan/lab/MCLIM++/experiments_M25M26_Extend'   # will be created if not exists
    adni_data_path: str = '/data3/junyan/dataset/ADNI_SSL_Rigid_4_MCLIMpp'
    multi_data_path: str = '/data3/junyan/dataset/Dataset_for_Multi_Serises_SSL_Rigid'
    atlas_path: str = '/data/junyan/lab/MCLIM++/standard/JHU5Levels/ATLAS/jhu20_2_MNI_atlas.nii.gz'
    ...
    input_size: int = 64
    feature_size: int = 32
    mim_ratio: float = 0.75 # MIM ratio for image, should be in (0, 1)
    patch_size: int = 16
    sbn: bool = True
    sparse: bool = True
